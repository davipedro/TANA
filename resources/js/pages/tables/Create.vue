...
const breadcrumbs = computed<BreadcrumbItem[]>(() => [
    ...
    { title: 'Nova Mesa', href: `/restaurants/${restaurant.value?.slug}/tables/create` },
]);
...
function submit() {
    form.post(`/restaurants/${restaurant.value.slug}/tables`, {
        preserveScroll: true,
    });
}
</script>
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6 max-w-2xl mx-auto">
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex gap-3">
                    ...
                    >
                        {{ form.processing ? 'Criando...' : 'Criar Mesa' }}
                    </Button>
                </div>
            </form>
        </div>
